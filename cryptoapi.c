                                 ...
                                 struct skcipher_def * sk)
{
	...
	pr_info("&sk->scratchpad = %u\n", &sk->scratchpad);
 	pr_info("######################################################\n");
	printk("sk->sg.pagelink = %u\n", sk->sg.page_link);
	printk("sk->sg.offset = %u\n", sk->sg.offset);
	printk("sk->sg.length = %u\n", sk->sg.length);
        pr_info("######################################################\n");
	printk("sk->req->dst->page_link = %u\n", sk->req->src->page_link);
	printk("sk->req->dst->offset = %u\n", sk->req->src->offset);
	printk("sk->req->dst->length = %u\n", sk->req->src->length);
	pr_info("######################################################\n");
	printk("sk->req->dst->page_link = %u\n", sk->req->dst->page_link);
	printk("sk->req->dst->offset = %u\n", sk->req->dst->offset);
	printk("sk->req->dst->length = %u\n", sk->req->dst->length);
	printk("sk->scratchpad = %s\n", sk->scratchpad);
	pr_info("hexdump: ");
